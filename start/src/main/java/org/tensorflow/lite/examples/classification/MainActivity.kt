...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buton = findViewById<Button>(R.id.seeRes)
            ...
            imageAnalyzer = ImageAnalysis.Builder()
                ...
                .also { analysisUseCase: ImageAnalysis ->
                    analysisUseCase.setAnalyzer(cameraExecutor, ImageAnalyzer(this) { items ->
                        ...
                        recogViewModel.recognitionList.value?.get(0).toString()
                        buton.setOnClickListener(){
                            //Toast.makeText(this,recogViewModel.recognitionList.value?.get(0).toString()+"",Toast.LENGTH_LONG).show()
                            val intent = Intent(this,BilgiActivity::class.java)
                            intent.putExtra("name",recogViewModel.recognitionList.value?.get(0).toString())
    ...
    private class ImageAnalyzer(ctx: Context, private val listener: RecognitionListener) :
        ...
        override fun analyze(imageProxy: ImageProxy) {
           ...
           /* for (i in 0..MAX_RESULT_DISPLAY-1){
            ...
            //BU KISMA BUTON OLAYINI EKLEYECEĞİZ
